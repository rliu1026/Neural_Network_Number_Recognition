...
public class DigitClassifier {
    ...
    public static void main(String[] args) {
        ...
        //System.out.println("testfile: " + args[4]);
    ...
    private static ArrayList<Instance> getData(String file) {
        ...
        try {
            ...
            while (in.ready()) {
                ...
                String prefix = line.substring(0, 2); // take first 2 characters of each line
                switch (prefix) {
                    case "//":
                        break;
                    case "##":
                        attributeCount = Integer.parseInt(line.substring(2)); // #pixels
                        break;
                    case "**":
                    ...
                    default:
                        ...
                        Instance inst = new Instance();
                        	// each instance records a complete line in file

                        // read all pixels:
                        for (int i = 0; i < attributeCount; i++)
                            inst.attributes.add(Double.parseDouble(vals[i]));

                        // read classification stated after pixels:
